...
| Feature                                                                           |     State      |
|-----------------------------------------------------------------------------------|:--------------:|
| **Height Pathfinding**<br>The basic height be dropped down on a path configurable | In Development |
| **Step Heights**<br>Make the height that can be stepped up configurable           |    Planned     |
| **Drop Heights**<br>Make the height that  stepped up at once configurable         |    Planned     |
